  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-white/60 dark:bg-white/5 backdrop-blur-2xl border border-slate-200/50 dark:border-white/10 shadow-xl hover:shadow-2xl">
        {/* Gradient header */}
        <div className={`relative h-32 bg-gradient-to-br ${system.gradient} p-6 overflow-hidden`}>
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            ...
            className={`w-full mt-4 py-3 px-4 rounded-xl bg-gradient-to-r ${system.gradient} hover:shadow-xl text-white shadow-lg transition-all duration-300 flex items-center justify-center gap-2 group/btn`}
          >
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
          <div className={`absolute inset-0 bg-gradient-to-br ${system.gradient} opacity-10 blur-2xl`} />
        </div>
      </div>
    </motion.div>
  );
